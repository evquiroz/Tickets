...
public interface IGlobalConstants {
  ...
  final static String SESS_CI_BEAN          = "ciBean";
  final static String SESS_TARGET_URL       = "pageTarget";
  final static String SESS_CI_LIST          = "incidentList";
  final static String SESS_PARENT_ID        = "parID";
  final static String SESS_PAR_BEAN         = "parBean";
  final static String SESS_REMEDY_ID        = "remedyID";
  final static String SESS_IMPACT_NAME      = "impactName";

  //// Valores en sesion
  final static String SESSION_APP_PARAMS    = "appParams";

  //// Nombres de las paginas 
  /** Lista de incidentes criticos */
  final static String PAGE_INC_LIST         = "incidentList";
  /** Forma de incidentes derivados */
  final static String PAGE_DERIVED_FORM     = "derivedForm";
  /** Forma de incidentes independientes */
  final static String PAGE_INCIDENT_FORM    = "incidentForm";
  /** Forma de requisicion */
  final static String PAGE_WORKORDER_FORM   = "workorderForm";
  ...
  // 
  final static String PROP_BMCAPI_HOST      = "api.host";
  final static String PROP_BMCAPI_PORT      = "api.port";
  final static String PROP_BMCAPI_USER      = "api.user";
  final static String PROP_BMCAPI_PWD       = "api.secret";
