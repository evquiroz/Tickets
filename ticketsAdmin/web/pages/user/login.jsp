...
<form action="${pageContext.request.contextPath}/service/userLogin.xhtm" name="loginForm" method="post">
  ...
  <tr>
    <td colspan="3">
      <div align="center" class="ui-widget-header ui-corner-tl ui-corner-tr jquiTableHeader loginFormTitle">
  ...
  <tr>
    <td align="center">
      <button id="buttonLogin" class="ui-button ui-widget ui-corner-all formButton" 
        ...
        &nbsp;
        <s:property value="getText('form.button.login')" />
      </button>
    </td>
  </tr>
  </table>
