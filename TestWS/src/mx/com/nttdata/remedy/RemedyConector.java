 ...
 * @version 1.0.0
 */
public class RemedyConector {

//  private final static String             DEF_ACTION            = "CREATE";
  private final static String             DEF_AS_ORG            = "Assigned_Support_Organization";  
//  private final static String             DEF_LAST_NAME         = "SIEM";  
//  private final static String             DEF_PERSON_ID         = "PPL000000028790";
  ...
  public String createincident( Incident bean ) throws Exception {
    ...
    try {
      ...
      ticket = port.helpDeskSubmitService(  
          ...
          null, //  department,
          bean.getCustomer(), //  firstName,
          bean.getImpact(), //  impact,
          bean.getLastName(), //  lastName, Se uso el mismo que en el ejemplo
          null, //  lookupKeyword,
          null, //  manufacturer,
