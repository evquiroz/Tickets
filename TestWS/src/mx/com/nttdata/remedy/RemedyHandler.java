 ...
 * @version 1.0.0
 */
public class RemedyHandler implements SOAPHandler<SOAPMessageContext> {

  public final static String AUTH_NODE_NAME = "AuthenticationInfo";
  public final static String USER_NODE_NAME = "userName";
  public final static String PWD_NODE_NAME  = "password";
  ...
  public boolean handleMessage( SOAPMessageContext context ) {
    ...
    if ( outbound ) {
       ...
       try {
         ...
         // userTag.addTextNode("siem");
         // secTag.addTextNode("qwe123");
  ...
  /*
  public RemedyHandler initValues( String user, String pwd ) { 
