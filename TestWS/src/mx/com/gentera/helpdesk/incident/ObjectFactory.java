 ...
 * generated in the mx.com.gentera.helpdesk.incident package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelpDeskSubmitServiceResponse_QNAME = new QName("urn:HPD_IncidentInterface_Create_WS", "HelpDesk_Submit_ServiceResponse");
    private final static QName _AuthenticationInfo_QNAME = new QName("urn:HPD_IncidentInterface_Create_WS", "AuthenticationInfo");
    private final static QName _HelpDeskSubmitService_QNAME = new QName("urn:HPD_IncidentInterface_Create_WS", "HelpDesk_Submit_Service");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mx.com.gentera.helpdesk.incident
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CreateOutputMap }{@code >}}
     * 
     */
    ...
    public JAXBElement<CreateOutputMap> createHelpDeskSubmitServiceResponse(CreateOutputMap value) {
        return new JAXBElement<CreateOutputMap>(_HelpDeskSubmitServiceResponse_QNAME, CreateOutputMap.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CreateInputMap }{@code >}}
     * 
     */
