...
public interface HPDIncidentInterfaceCreateWSPortTypePortType {
    ...
    @RequestWrapper(localName = "HelpDesk_Submit_Service", targetNamespace = "urn:HPD_IncidentInterface_Create_WS", className = "mx.com.gentera.helpdesk.incident.CreateInputMap")
    @ResponseWrapper(localName = "HelpDesk_Submit_ServiceResponse", targetNamespace = "urn:HPD_IncidentInterface_Create_WS", className = "mx.com.gentera.helpdesk.incident.CreateOutputMap")
