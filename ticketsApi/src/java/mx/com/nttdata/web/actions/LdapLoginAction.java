...
import mx.com.nttdata.service.LoginService;
import mx.com.nttdata.util.IGlobalConstants;
import mx.com.nttdata.util.Messages;


/**
 * Accion para manejar el ingreso de los usuarios en LDAP
 * @version 1.0.0
 */
public class LdapLoginAction extends ActionSupport implements SessionAware, ApplicationActions {


  /** Auxiliar de serializacion */
  private static final long serialVersionUID = -2049388423822947743L;
  ...
  public String login() throws Exception {
    ...
    IUserService svc = new LoginService();
